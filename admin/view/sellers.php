...
<div class="name">
    <h1 class="text-primary text-bold text-center">All sellers are shown bellow</h1>
...
$sql="SELECT * FROM registration WHERE Type = 'seller'";
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo "<td><a class='btn btn-danger btn-sm' href='../Controller/deleteAction.php?id=".$row['id']."'>Delete</a></td>";
 echo "</tr>";
  $number++;
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Register New Sellers</h4>
	...
	<?php
      ...
      ?>
		...
		<br>
		<button class="btn btn-success" style="border: 2px solid black ;" onclick="addRecord()"> Sign Up</button> <input class="btn btn-primary" style="border: 2px solid black ;" type="reset" name="reset">
		</form>
		</div>
	</div>
        </div>
